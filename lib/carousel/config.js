...
export const LENS = {
  // Which effect the fullscreen pass runs. 'glass' is the refracting lens
  // below; 'sphere' instead wraps the row around a cylinder whose ends roll
  // toward the camera, so the outer panels sit closer and magnify. Both leave
  // the middle alone (see edgeClear) so the active card stays flat.
  mode: "glass", // 'glass' | 'sphere'
  sphereCurve: 0.6, // how much taller the panels grow at the ends
  sphereSpread: 0.18, // how far the row stretches outward as it curves
  sphereShade: 0.12, // light falloff as the surface turns away
